...
public class MyRecFootManAdapter extends RecyclerView.Adapter<MyRecFootManAdapter.ViewHolder> {
    ...
    public MyRecFootManAdapter(List<Order> oList){mOrderList = oList;}
